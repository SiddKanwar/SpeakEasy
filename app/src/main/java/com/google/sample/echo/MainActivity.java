...
public class MainActivity extends Activity
    ...
    private  static SeekBar vol_bar;
    private  static TextView vol_text;
    private  static SeekBar delay_bar;
    private  static TextView delay_text;
    ...
    public void vol_Slider() {
        vol_bar = (SeekBar)findViewById(R.id.vol_slider);
        vol_text = (TextView)findViewById(R.id.vol_text);
        vol_text.setText("Covered: " + (vol_bar.getProgress()/10) + "/" + (vol_bar.getMax()/10));

        vol_bar.setOnSeekBarChangeListener(
                new SeekBar.OnSeekBarChangeListener() {
                    int progress_val = 0;
                    @Override

                    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                        progress_val = process;

                        vol_text.setText("Covered: " + (vol_bar.getProgress()/10) + "/" + (vol_bar.getMax()/10));
                        Toast.makeText(getApplicationContext(),"Volume in progress", Toast.LENGTH_LONG).show();
                    }

                    @Override
                    public void onStartTrackingTouch(SeekBar seekBar) {
                        Toast.makeText(getApplicationContext(),"Volume in StartTracking", Toast.LENGTH_LONG).show();
                    ...
                    public void onStopTrackingTouch(SeekBar seekBar) {
                        vol_text.setText("Covered: " + (vol_bar.getProgress()/10) + "/" + (vol_bar.getMax()/10));
                        Toast.makeText(getApplicationContext(),"Volume in StopTacking", Toast.LENGTH_LONG).show();
    ...
    public void delay_slider() {
        delay_bar = (SeekBar)findViewById(R.id.delay_slider);
        delay_text = (TextView)findViewById(R.id.delay_text);
        delay_text.setText("Covered: " + delay_bar.getProgress()/10 + "/" + delay_bar.getMax()/10);
        ...
        delay_bar.setOnSeekBarChangeListener(
                new SeekBar.OnSeekBarChangeListener() {
                    ...
                    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                        progress_val = process;
                        //sliderToDelayVal = (delay_bar.getProgress()/10)+4;
/*
                        delay_text.setText("Covered: " + (delay_bar.getProgress()/10) + "/" + (delay_bar.getMax()/10));
*/
                        delay_text.setText("Covered: " + (delay_bar.getProgress()/10) + "/" + (delay_bar.getMax()/10));

                        Toast.makeText(getApplicationContext(),"Delay in progress", Toast.LENGTH_LONG).show();
                    }

                    @Override
                    public void onStartTrackingTouch(SeekBar seekBar) {
                        Toast.makeText(getApplicationContext(),"Delay in StartTracking", Toast.LENGTH_LONG).show();
                    ...
                    public void onStopTrackingTouch(SeekBar seekBar) {
                        delay_text.setText("Covered: " + (delay_bar.getProgress()/10) + "/" + (delay_bar.getMax()/10));
                        Toast.makeText(getApplicationContext(),"Delay in StopTacking", Toast.LENGTH_LONG).show();
